CREATE TABLE IF NOT EXISTS "cpoe_prescription_note" (
...
CREATE INDEX IF NOT EXISTS "cpoe_prescription_note_visit_id_idx" ON "cpoe_prescription_note" USING btree ("visit_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "cpoe_prescription_note_patient_id_idx" ON "cpoe_prescription_note" USING btree ("patient_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "cpoe_prescription_note_branch_id_idx" ON "cpoe_prescription_note" USING btree ("branch_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "cpoe_prescription_note_status_id_idx" ON "cpoe_prescription_note" USING btree ("status_id");
