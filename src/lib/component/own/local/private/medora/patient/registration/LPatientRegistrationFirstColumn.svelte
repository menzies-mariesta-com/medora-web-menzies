...
<div class="flex flex-col gap-4">
	...
	<div
		class="flex min-w-0 flex-col gap-1 sm:flex-row sm:items-center sm:gap-3"
	>
		<label for="first-name" class="shrink-0 sm:w-36 font-bold">First Name <span class="text-error">*</span></label>
		<div class="max-w-80 flex-1">
			<WashInputField bind:value={firstName} inputType="text" />
		</div>
	</div>
	<div
		class="flex min-w-0 flex-col gap-1 sm:flex-row sm:items-center sm:gap-3"
	>
		<label for="middle-name" class="shrink-0 sm:w-36 font-bold">Middle Name</label>
		<div class="max-w-80 flex-1">
