...
<div class="flex flex-col gap-4">
	...
	>
		<DaisyUiLabel forText="patient-code" className="shrink-0 sm:w-36"
			>Patient Code</DaisyUiLabel
		>
	...
	>
		<DaisyUiLabel
			forText="middle-name"
			className="shrink-0 sm:w-36 font-bold">Middle Name</DaisyUiLabel
		>
		<div class="max-w-80 flex-1">
	...
	>
		<DaisyUiLabel
			forText="last-name"
			className="shrink-0 sm:w-36 font-bold">Last Name</DaisyUiLabel
		>
		<div class="max-w-80 flex-1">
	...
	>
		<DaisyUiLabel
			forText="email"
			className="shrink-0 sm:w-36 font-bold">Email</DaisyUiLabel
		>
		<div class="max-w-80 flex-1">
			<DaisyUiInputField
				bind:value={email}
