<script lang="ts">
	...
	import { ManufacturerModalState } from '$lib/state/manufacturer-modal.state.svelte';
	...
	const modalState = $derived(ManufacturerModalState);
...
{:else}
	<form onsubmit={handleSubmit} class="flex max-h-[min(70vh,36rem)] flex-col gap-4 overflow-y-auto pe-1">
		...
		>
			<DaisyUiLabel forText="mfr-name" className="shrink-0 sm:w-40"
				>{m.manufacturer_name()}
			...
			<div class="max-w-lg flex-1">
				<DaisyUiInputField
					...
					bind:value={name}
					inputType="text"
					inputPlaceholderText={m.manufacturer_name()}
					required
				/>
			</div>
		</div>
		<div
			class="flex min-w-0 flex-col gap-1 sm:flex-row sm:items-center sm:gap-3"
		>
			<DaisyUiLabel forText="mfr-code" className="shrink-0 sm:w-40"
				>{m.manufacturer_code()}</DaisyUiLabel
			>
			<div class="max-w-lg flex-1">
				<DaisyUiInputField
					id="mfr-code"
					bind:value={code}
					inputType="text"
					inputPlaceholderText={m.manufacturer_code()}
				/>
			</div>
		</div>
		<div class="flex min-w-0 flex-col gap-1 sm:flex-row sm:items-start sm:gap-3">
			<DaisyUiLabel forText="mfr-addr" className="shrink-0 sm:w-40"
		...
		<div
			class="flex min-w-0 flex-col gap-1 sm:flex-row sm:items-center sm:gap-3"
		>
			<DaisyUiLabel forText="mfr-country" className="shrink-0 sm:w-40"
		...
		<div
			class="flex min-w-0 flex-col gap-1 sm:flex-row sm:items-center sm:gap-3"
		>
			<DaisyUiLabel forText="mfr-state" className="shrink-0 sm:w-40"
		...
		<div
			class="flex min-w-0 flex-col gap-1 sm:flex-row sm:items-center sm:gap-3"
		>
			<DaisyUiLabel forText="mfr-city" className="shrink-0 sm:w-40"
				>{m.city()}</DaisyUiLabel
			>
			<div class="max-w-lg flex-1">
				<DaisyUiSelect
		...
		<div
			class="flex min-w-0 flex-col gap-1 sm:flex-row sm:items-center sm:gap-3"
		>
			<DaisyUiLabel forText="mfr-postal" className="shrink-0 sm:w-40"
		...
		<div
			class="flex min-w-0 flex-col gap-1 sm:flex-row sm:items-center sm:gap-3"
		>
			<DaisyUiLabel forText="mfr-phone-cc" className="shrink-0 sm:w-40"
		...
		<div
			class="flex min-w-0 flex-col gap-1 sm:flex-row sm:items-center sm:gap-3"
		>
			<DaisyUiLabel forText="mfr-phone" className="shrink-0 sm:w-40"
		...
		<div
			class="flex min-w-0 flex-col gap-1 sm:flex-row sm:items-center sm:gap-3"
		>
			<DaisyUiLabel forText="mfr-email" className="shrink-0 sm:w-40"
		...
		<div class="flex min-w-0 flex-col gap-1 sm:flex-row sm:items-start sm:gap-3">
			<DaisyUiLabel forText="mfr-remark" className="shrink-0 sm:w-40"
