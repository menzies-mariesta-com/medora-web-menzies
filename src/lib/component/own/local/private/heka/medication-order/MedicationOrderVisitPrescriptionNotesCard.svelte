...
<DaisyUiCard className="flex h-full w-full flex-col">
	<DaisyUiCardBody className="flex min-h-0 flex-1 flex-col gap-2 p-4">
		<DaisyUiCardBodyTitle className="shrink-0 text-base">
