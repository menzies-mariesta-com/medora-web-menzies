...
/** For UI: show "All tickets" tab only when system admin. */
export const getSupportTicketSession = query(
	async (): Promise<SupportTicketSessionResult> => {
...
export const createSupportTicket = command(
	...
	async (payload: {
		...
		getMySupportTicketsPaginated().refresh();
		getAllSupportTicketsPaginated().refresh();
...
export const getMySupportTicketsPaginated = query(
	'unchecked' as const,
	async (
...
export const getAllSupportTicketsPaginated = query(
	'unchecked' as const,
	async (
		params?: TicketListParams
	): Promise<PaginatedResult<SupportTicketSchema>> => {
...
export const getSupportTicketById = query(
	'unchecked' as const,
	async ({ id }: { id: number }) => {
		const { userId, userRoleId } = requireUser();
...
export const updateSupportTicket = command(
	'unchecked' as const,
	async (payload: {
		id: number;
		...
		getMySupportTicketsPaginated().refresh();
		getAllSupportTicketsPaginated().refresh();
		getSupportTicketById({ id }).refresh();
