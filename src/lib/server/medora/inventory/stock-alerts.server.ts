...
} from '$lib/server/medora/inventory/stock-alert-settings.server';
import { sendEmailServer } from '$lib/server/util/mailer.server';
import { log } from '$lib/logger';
import { MAX_REPORT_EXPORT_ROWS } from '$lib/server/medora/inventory/reports/report-export.server';
...
async function dispatchStoreScopedStockAlerts(params: {
	...
	const base = `/medora/hospital/${hospitalId}/home/inventory/reports`;
