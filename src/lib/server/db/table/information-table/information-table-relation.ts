...
export const patientVisitTableRelations = relations(patientVisitTable, ({ one, many }) => ({
	patient: one(patientTable, {
...
export const patientDiagnosisTableRelations = relations(patientDiagnosisTable, ({ one }) => ({
	patient: one(patientTable, {
