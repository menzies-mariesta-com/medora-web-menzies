...
export const referTypeTableRelations = relations(
	referTypeTable,
	({ one, many }) => ({
		status: one(statusTable, {
...
export const religionTableRelations = relations(
	religionTable,
	({ one, many }) => ({
		status: one(statusTable, {
...
export const weekdayTableRelations = relations(
	weekdayTable,
	({ one, many }) => ({
		status: one(statusTable, {
...
export const allergyMasterTableRelations = relations(
	allergyMasterTable,
	({ one, many }) => ({
		status: one(statusTable, {
