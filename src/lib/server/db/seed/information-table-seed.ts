...
export async function seedInformationTables() {
	...
	await db.execute(sql`
		...
		VALUES
			...
			(43, 'Pricing configuration', 9, 1, null, '/heka/home/inventory-setup/pricing-config', 9),
			(430001, 'Pricing formula templates', 9, 1, null, '/heka/home/inventory-setup/pricing-formula-templates', 10),
			(32, 'Reorder level', 9, 1, null, '/heka/home/inventory-setup/reorder-level', 11),
			(42, 'Stock alerts', 9, 1, null, '/heka/home/inventory-setup/stock-alerts', 12),
