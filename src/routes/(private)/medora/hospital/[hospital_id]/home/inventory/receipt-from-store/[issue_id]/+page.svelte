<script lang="ts">
	...
	import DepartmentIssueDetailView from '$lib/component/own/local/private/medora/inventory/department-issue/DepartmentIssueDetailView.svelte';
	...
	const backHref = $derived(
		resolve(
			medoraHospitalPageUrl(
				hospitalId,
				'/medora/home/inventory/receipt-from-store' as const
			) as any
		)
	);
</script>

<DepartmentIssueDetailView
	{hospitalId}
	{issueId}
	{backHref}
