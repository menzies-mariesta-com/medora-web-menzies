...
>
	...
	<div class="w-full space-y-4">
		<div
			class="stats w-full stats-vertical rounded-2xl border border-base-300/70 bg-base-100/95 shadow-lg lg:stats-horizontal"
		>
			<div class="stat">
		...
		>
			<div class="stat">
				...
				<div class="stat-title">Case history</div>
			...
			<div class="stat">
				...
				<div class="stat-title">Visits (7 days)</div>
		...
		>
			<div class="stat">
				...
				<div class="stat-title">Unbill</div>
				<div class="stat-value">
			...
			<div class="stat">
				...
				<div class="stat-title">Check-in ratio to confirm</div>
				<div class="stat-value text-info">
	...
	<div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-6">
		<div
			class="card rounded-2xl border border-base-300/70 bg-gradient-to-br from-primary/10 via-base-100 to-base-100 shadow-lg"
		>
			<div class="card-body">
		...
		<div
			class="card rounded-2xl border border-base-300/70 bg-base-100/95 shadow-lg"
		>
			<div class="card-body grid gap-3">
				<h3 class="card-title text-base">Today at a glance</h3>
