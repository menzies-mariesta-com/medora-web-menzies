<script lang="ts">
	...
	import ItemUnitMasterFormModal from '$lib/component/own/local/private/medora/inventory-setup/item-unit-master/ItemUnitMasterFormModal.svelte';
	...
	const apiBase = $derived(
		hospitalId
			? `/api/medora/hospital/${hospitalId}/home/inventory-setup/item-unit-master`
			: ''
	);
	...
	const columns: MenziesTableColumn<ItemUnitMasterListRow>[] = [
		{
...
<div class={TableEnum.HEIGHT}>
	<MenziesTable
		title={m.item_unit_master_title()}
		showAddButton={true}
		addLabel={m.new_item_unit_master()}
		onAdd={openCreate}
		{rows}
					{columns}
					{isLoading}
