<script lang="ts">
	...
	import type { PrefixFieldPath } from '$lib/model/type/medora/prefix-format.type';
	import type { PrefixFormatListRow } from '$lib/model/type/medora/ui-rows.type';
	...
	function prefixConfigurationApiUrl() {
		return `/api/medora/hospital/${hospitalId}/home/administration/prefix-configuration`;
	}
		...
		<WashCardBody>
			...
			>
				<fieldset class="m-0 min-w-0 border-0 p-0">
					<WashCardBodyTitle className="mb-3">
					...
					<fieldset class="m-0 min-w-0 flex-1 border-0 p-0">
						...
						>
							...
							<div class="col-span-full flex min-w-0 flex-col gap-2">
										...
										>
											...
											>
												{#if part.kind === 'literal'}
													<WashInputField
														className="input-xs h-7 min-h-7 w-full py-0 text-xs"
												...
												{:else}
													...
													>
														...
														<input
															...
															class="input-bordered input input-xs h-7 w-14 py-0 text-center text-xs tabular-nums"
															value={part.padStart}
															oninput={(e) =>
																setSequencePad(
																	i,
											...
											>
												<button
													type="button"
													class="btn h-7 min-h-7 px-1.5 btn-ghost btn-xs"
												...
												<button
													type="button"
													class="btn h-7 min-h-7 px-1.5 btn-ghost btn-xs btn-error"
								...
								<WashButton
									type="button"
									className="btn-outline btn-xs h-8 min-h-8 w-fit gap-1 px-2"
				...
				<WashCardBodyAction className="mt-4 flex flex-wrap gap-2">
					<WashButton
						type="submit"
