<script lang="ts">
	...
	import LAdministrationStaffRegistrationFirstColumn from '$lib/component/own/local/private/medora/administration/staff/registration/LStaffRegistrationFirstColumn.svelte';
	import { authClient } from '$lib/auth/client';
	import { RouterUtil } from '$lib/util/router.util.svelte';
	import { DateTimeUtil } from '$lib/util/date-time.util.svelte';
	import LStaffRegistrationThirdColumn from '$lib/component/own/local/private/medora/administration/staff/registration/LStaffRegistrationThirdColumn.svelte';
	import LStaffRegistrationSecondColumn from '$lib/component/own/local/private/medora/administration/staff/registration/LStaffRegistrationSecondColumn.svelte';
	import LStaffRegistrationMoreInfo from '$lib/component/own/local/private/medora/administration/staff/registration/LStaffRegistrationMoreInfo.svelte';
	import LStaffRegistrationPermissions from '$lib/component/own/local/private/medora/administration/staff/registration/LStaffRegistrationPermissions.svelte';
	...
	function staffRegistrationApiUrl(
		...
		return `/api/medora/hospital/${hid}/home/administration/staff/registration?${usp.toString()}`;
	}
