<script lang="ts">
	...
	import LObservationAllergyDeleteDialogContent from '$lib/component/own/local/private/heka/observation/LObservationAllergyDeleteDialogContent.svelte';
	...
	const cpoeOrderRedirectHref = $derived(
		hospitalId && visitId
			? `/heka/hospital/${hospitalId}/home/consultation/cpoe/order?visitId=${visitId}`
			: ''
	);
